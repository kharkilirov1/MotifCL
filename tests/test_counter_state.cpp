...
int main() {
    try {
        ...
        // x deliberately has NO requires_grad: a counter layer must still update its own
        // finite-state weights (training-gated update, independent of input gradient). This
        // is the regression witness for the requires_grad-independent update fix.
